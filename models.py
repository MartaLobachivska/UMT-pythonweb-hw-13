...
class User(Base):
    """Database model for an authenticated API user."""
    __tablename__ = "users"
    ...
    role: Mapped[str] = mapped_column(String(10), default="user", nullable=False, server_default="user")
...
class Contact(Base):
    """A private contact that belongs to exactly one user."""
